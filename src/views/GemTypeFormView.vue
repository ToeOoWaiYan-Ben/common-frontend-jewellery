<template>
  <section>
    ...
    <div class="users-header">
      ...
      <RouterLink to="/" class="users-search__back-link">
        ← Back
      </RouterLink>
    </div>
    ...
    <div class="card" style="margin-bottom: 14px;">
      ...
      <div class="category-form">
        ...
        <div style="display:flex; gap:10px; justify-content:flex-end; margin-top:12px;">
          ...
          <button class="btn-primary" type="button" @click="submit" :disabled="store.loading || !name">
    ...
    <div class="card">
      <div style="display:flex; justify-content:space-between; align-items:flex-end; gap:12px; margin-bottom:12px;">
        ...
        <input v-model.trim="q" class="category-form__input" style="max-width:280px;"
               placeholder="Search..." />
      </div>
          ...
          <tbody>
            ...
            <tr v-for="x in filtered" :key="x.id" :class="{ 'row--editing': x.id === editingId }">
              ...
              <td style="text-align:center;">
                <button class="pagination-btn" @click="startEdit(x.id, x.name)" :disabled="store.loading">
                  Edit
                </button>
                <button class="pagination-btn" style="border-color:#fecdd3; background:#fff1f2; color:#9f1239;"
                        @click="del(x.id, x.name)" :disabled="store.loading">
                  Delete
                </button>
              </td>
            </tr>
