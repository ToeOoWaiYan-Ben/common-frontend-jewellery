<template>
  <section class="dashboard">
    ...
    <div v-else>
      <!-- KPI -->
      <div class="kpi-grid">
        <div class="card">Total Sales: <b>{{ money(data.todaySales) }}</b></div>
        <div class="card">Period Sales: <b>{{ money(data.monthSales) }}</b></div>
        <div class="card">Purchases: <b>{{ data.purchasesToday }}</b></div>
