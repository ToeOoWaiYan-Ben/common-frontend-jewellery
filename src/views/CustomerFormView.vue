...
<template>
  <section>
    ...
    <div class="users-header">
      ...
      <RouterLink to="/customers" class="users-search__back-link"> ← Back to Customers </RouterLink>
    </div>
    ...
    <div class="card">
      <form class="category-form" @submit.prevent="handleSubmit">
        ...
        <div class="category-form__actions">
          <RouterLink to="/customers" class="btn-secondary" type="button"> Cancel </RouterLink>
...
<script setup lang="ts">
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formError.value = e?.message ?? 'Something went wrong while creating the customer.'
    } finally {
